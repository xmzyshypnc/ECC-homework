...
//	private static Log logger = LogFactory.getLog(SM3.class);
	...
	private static Integer FF(Integer x, Integer y, Integer z, int j)
	{
		...
		else if (j >= 16 && j <= 63)
		{
			return Integer.valueOf((x.intValue() & y.intValue()) |
					(x.intValue() & z.intValue()) | (y.intValue() & z.intValue()));
		} 
		else
		{
			throw new RuntimeException("data invalid");
	...
	private static Integer P0(Integer x)
	{
		return Integer.valueOf(x.intValue() ^
				Integer.rotateLeft(x.intValue(), 9) ^ Integer.rotateLeft(x.intValue(), 17));
	}

	private static Integer P1(Integer x)
	{
		return Integer.valueOf(x.intValue() ^
				Integer.rotateLeft(x.intValue(), 15) ^ Integer.rotateLeft(x.intValue(), 23));
	}
...
//		}
	...
	public static String hash(String Src) throws IOException
	{
...
//		}
	...
	private static String ToString(byte[] byteArray)
	{
		...
		{
			IntArray[i] = (int)byteArray[i] + 128;
			String temp = Integer.toBinaryString(IntArray[i]);
			while(temp.length() < 8)
			{
				temp = "0" + temp;
			}
